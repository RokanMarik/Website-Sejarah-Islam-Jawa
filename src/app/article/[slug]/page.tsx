        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-1/5 lg:sticky lg:top-32 py-4 border-b lg:border-b-0 lg:border-r border-gray-800 pr-6">
            ...
            <div className="flex gap-4">
              <button type="button" className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:border-yellow-400 hover:text-yellow-400 transition-colors">
